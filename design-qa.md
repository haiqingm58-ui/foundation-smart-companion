...
source visual truth path: screenshots/login-wide-before-1920.png
implementation wide screenshot path: screenshots/login-wide-after-1920.png
implementation ultrawide screenshot path: screenshots/login-wide-after-2560.png
implementation desktop regression path: screenshots/login-wide-regression-1440.png
implementation mobile regression path: screenshots/login-wide-regression-mobile.png
comparison evidence path: screenshots/login-wide-comparison.png
...
**Verification**
- Automated wide-layout regression: `tests/e2e/login-layout.spec.mjs` checks exact card geometry, 560-680px login-panel width, at least 50% viewport coverage, zero card/footer overlap, balanced vertical gaps, and no horizontal overflow at 1920 and 2560. It also verifies the large-screen rule stays inactive at 1499 x 900 and 1500 x 899, then activates at 1500 x 900.
- Full browser workflow: `npm run test:e2e` passed 2 Playwright flows in a clean server state, including the teacher-paper/student-answering loop and the responsive login layout.
...
- Measured 1920 geometry: brand bottom 239.5px; card left 64px, top 278.75px, width 1792px, height 720px; login panel width 652.8px; footer top 1038px; top and bottom gaps 39.25px; document and viewport widths both 1920px.
- Measured 2560 geometry: card left 240px, top 368.75px, width 2080px, height 900px; login panel width 680px; top and bottom gaps 129.25px; document and viewport widths both 2560px.
